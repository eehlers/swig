...
DLLEXPORT int xlAutoOpen() {
    ...
    try {
        ...
        Excel(xlfRegister, 0, 7, &xDll,
            TempStrNoSize("\x08""slAdder2"),             // function code name
            TempStrNoSize("\x04""CCN#"),                // parameter codes
            TempStrNoSize("\x08""slAdder2"),             // function display name
        ...
        Excel(xlfRegister, 0, 7, &xDll,
            TempStrNoSize("\x0B""slAdder2Add"),          // function code name
            TempStrNoSize("\x04""NCN#"),                // parameter codes
            TempStrNoSize("\x0B""slAdder2Add"),          // function display name
            TempStrNoSize("\x0A""ObjectID,x"),          // comma-delimited list of parameters
            TempStrNoSize("\x01""1"),                   // function type (0 = hidden function, 1 = worksheet function, 2 = command macro)
            TempStrNoSize("\x07""Example"));            // function category
...
DLLEXPORT char *slAdder2(
    ...
    try {
        ...
        functionCall = boost::shared_ptr<ObjectHandler::FunctionCall>
            (new ObjectHandler::FunctionCall("slAdder2"));

        boost::shared_ptr<ObjectHandler::ValueObject> valueObject(
            new ValueObjects::slAdder2(objectID, false, *x));

        boost::shared_ptr<ObjectHandler::Object> object(
            new SimpleLibAddin::Adder2(valueObject, false, *x));
...
DLLEXPORT long *slAdder2Add(char *objectID, long *y) {
    ...
    try {
        ...
        functionCall = boost::shared_ptr<ObjectHandler::FunctionCall>
            (new ObjectHandler::FunctionCall("slAdder2Add"));
